...
/**
 * Jersey REST client generated for REST resource:ProjectFacadeREST [project]<br>
 * USAGE:
 * <pre>
 ...
 * @author gsalg
 */
public class ProjectRESTClient implements ProjectManager {
    ...
    public <T> T findProjectByText(Class<T> responseType, String text) throws ClientErrorException {
        ...
        resource = resource.path(java.text.MessageFormat.format("text/{0}", new Object[]{text}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
    public List<Project> getProjects(){
        List<Project> projects = this.findAllProject(new GenericType<List<Project>>() {});
        return projects;
    }
